			...
			dist: {
				options: {
					patterns: [{
						...
						match: /elements\/app-root-elements\.html/g,
						replacement: 'elements/app-root-elements.vulcanized.html'
					}]
				},
				files: {
					'<%= yeoman.dist %>/index.html': ['<%= yeoman.dist %>/index.html'],
					'<%= yeoman.dist %>/elements/app-root-elements.vulcanized.html': ['<%= yeoman.dist %>/elements/app-root-elements.vulcanized.html']
				}
			}
		},
		vulcanize: {
			appRootElements: {
				...
				files: {
					'<%= yeoman.dist %>/elements/app-root-elements.vulcanized.html': [
						'<%= yeoman.dist %>/elements/app-root-elements.html'
					]
				}
			},
			restOfTheElements: {
